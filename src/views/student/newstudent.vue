<template>
  <div>
    <el-form ref="studentForm" :model="studentForm" :rules="rules">
      ...
      <el-row>
        ...
        <el-form-item label="手机" prop="deviceid">
          <el-col span="6">
            <el-input v-model="studentForm.deviceid" placeholder="手机序列号" />
          </el-col>
          <el-button type="info" @click="onSearch">获取手机型号</el-button>
        </el-form-item>
        <el-form-item label="型号">
          <el-col span="8">
            <el-input v-model="studentForm.model" placeholder="" />
          </el-col>
        </el-form-item>
      </el-row>
      <el-form-item label="照片" prop="imageUrl">
        ...
        >
          <img v-if="studentForm.imageUrl" :src="studentForm.imageUrl" class="avatar"> <i
            v-else
  ...
  data() {
    return {
      ...
      rules: {
        ...
        deviceid: [
          { required: true, message: '获取手机类型', trigger: 'blur' }
        ],
        imageUrl: [
